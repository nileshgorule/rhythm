...
<head>
    ...
    <meta name="description" content="Danza - Dancing School and Ballet Studio">
    <meta name="keywords" content="Danza - Dancing School and Ballet Studio">
...
<body class="theme-blue">
  ...
  ============================== -->
    <div class="th-menu-wrapper">
        <div class="th-menu-area style3 text-center">
            ...
            <div class="mobile-logo">
                <a href="index.php"><img src="assets/img/logo.png" alt="Rhythems"></a>
            </div>
	...
	Header Area
==============================-->
    <header class="th-header header-layout1 header-absolute mb-5">
...
<!--==============================
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="assets\img\sample\bg_image2.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Blog – Grid (3 Columns)</h1>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.html"><i class="fa-light fa-calendar-days"></i>30 Oct, 2023</a>
                                <a href="blog.html"><i class="fa-regular fa-tags"></i>classic dance</a>
                                <a href="blog-details.html"><i class="fa-regular fa-comments"></i>Comments(3)</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">10 Tips For Taking Online Classic Dance Classes</a>
                            </h2>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">Classical dance forms require precise technique</a>
                            </h2>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">the opportunity, share videos of your practice</a>
                            </h2>
                            <p class="blog-text">Uniquely iterate e-business catalysts for change without cross functional supply chains. Completely harness extensible infrastructures via future-proof infomediaries. Rapaciously grow competitive collaboration and idea-sharing without intuitive..</p>
                            <a href="blog-details.html" class="th-btn">READ MORE<i class="fa-solid fa-right-long ms-2"></i></a>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">find videos that show the instructor</a>
                            </h2>
                            <p class="blog-text">Uniquely iterate e-business catalysts for change without cross functional supply chains. Completely harness extensible infrastructures via future-proof infomediaries. Rapaciously grow competitive collaboration and idea-sharing without intuitive..</p>
                            <a href="blog-details.html" class="th-btn">READ MORE<i class="fa-solid fa-right-long ms-2"></i></a>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">dance studios on social media platforms</a>
                            </h2>
                            <p class="blog-text">Uniquely iterate e-business catalysts for change without cross functional supply chains. Completely harness extensible infrastructures via future-proof infomediaries. Rapaciously grow competitive collaboration and idea-sharing without intuitive..</p>
                            <a href="blog-details.html" class="th-btn">READ MORE<i class="fa-solid fa-right-long ms-2"></i></a>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html">community centers, Gyms or cultural centers</a>
                            </h2>
                            <p class="blog-text">Uniquely iterate e-business catalysts for change without cross functional supply chains. Completely harness extensible infrastructures via future-proof infomediaries. Rapaciously grow competitive collaboration and idea-sharing without intuitive..</p>
                            <a href="blog-details.html" class="th-btn">READ MORE<i class="fa-solid fa-right-long ms-2"></i></a>
                        </div>
...
==============================-->
                        ...
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <a href="index.html"><img src="assets/img/logo.png" alt="Danza"></a>
                                </div>
                                <p class="about-text">Credibly synthesize visionary systems before functionalized channels. Dynamically enable
                            ...
                            <div class="th-widget-contact">
                                <div class="info-box">
                                    ...
                                    <p class="info-box_text">
                                        Jogheswari East, Mumbai 400060, Maharashtra, INDIA
                                    </p>
                                </div>
                                <div class="info-box">
                                    <div class="info-box_icon">
                                    ...
                                    <p class="info-box_text">
                                        <a href="tel:+(91)-1202-0088" class="info-box_link">+(91)-1202-0088</a>
                                        <a href="tel:+(91)-1202-0099" class="info-box_link">+(91)-1202-0099</a>
                                    </p>
                                </div>
                                <div class="info-box">
                                    <div class="info-box_icon">
                        ...
                        <div class="widget footer-widget">
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="#"><img src="assets\img\sample\7252813.jpg" alt="Blog Image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="blogs.php">You're Blog Here</a></h4>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2024
                            By
                            <a href="#">therythmers.com</a>. All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-lg-6">
	...
	<a href="https://api.whatsapp.com/send?phone=919619958806" class="whatsapp-btn" target="_blank">
	 <span><i class="fab fa-whatsapp" aria-hidden="true"></i></span>
	</a>
	<a href="tel:+919619958806">
	  <!-- <img class="call_btn" src="../img/Call Us Now 4-1.webp" alt="Call us"> -->
	  <img class="call_btn" src="assets/img/call_now.svg" alt="Call us">
	</a>
    <!--********************************
			Code End  Here 
	******************************** -->
